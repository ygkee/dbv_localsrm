CREATE TABLE `company_attachment_link` (
  ...
  KEY `company_attachment_link__attachment__local__idx` (`local`),
  CONSTRAINT `company_attachment_link_ibfk_1` FOREIGN KEY (`permission_by`) REFERENCES `user_login` (`id`)
