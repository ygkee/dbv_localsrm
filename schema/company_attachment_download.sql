CREATE TABLE `company_attachment_download` (
  ...
  CONSTRAINT `company_attachment_download_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `user_login` (`id`),
  CONSTRAINT `company_attachment_download_ibfk_2` FOREIGN KEY (`attach_file_id`) REFERENCES `company_attachment_file` (`id`)
