CREATE TABLE `srm_drawing_attachment_link` (
  ...
  KEY `srm_drawing_attachment_link__attachment__local__idx` (`local`),
  CONSTRAINT `srm_drawing_attachment_link_ibfk_1` FOREIGN KEY (`permission_by`) REFERENCES `user_login` (`id`)
