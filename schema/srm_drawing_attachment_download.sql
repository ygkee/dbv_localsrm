CREATE TABLE `srm_drawing_attachment_download` (
  ...
  CONSTRAINT `srm_drawing_attachment_download_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `user_login` (`id`),
  CONSTRAINT `srm_drawing_attachment_download_ibfk_2` FOREIGN KEY (`attach_file_id`) REFERENCES `srm_drawing_attachment_file` (`id`)
