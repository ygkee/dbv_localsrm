CREATE TABLE `srm_po_data_1` (
  ...
  `f_po_type` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `f_vendor` int(11) DEFAULT NULL,
  `f_total_price` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `f_salesperson` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `f_required_feedback` text COLLATE utf8_unicode_ci,
  `f_remark` text COLLATE utf8_unicode_ci,
  `f_company_data` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `f_vendor_data` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `f_buyer_data` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `f_salesperson_data` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
